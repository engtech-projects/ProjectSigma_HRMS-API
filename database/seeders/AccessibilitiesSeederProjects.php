    ...
    public function run(): void
    {
        ...
        DB::table('accessibilities')->upsert(
            [
                ...
                [
                    'id' => 3031,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_MY_PROJECTS->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3032,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_BIDDING_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3033,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_PROPOSAL_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3034,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_ARCHIVED_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3035,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_ON_HOLD_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3036,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_AWARDED_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 3037,
                    'accessibilities_name' => AccessibilityProjects::PROJECTMONITORING_MARKETING_DRAFT_LIST->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
