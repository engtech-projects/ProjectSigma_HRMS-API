    ...
    public function run(): void
    {
        ...
        DB::table('accessibilities')->upsert(
            [
                ...
                [
                    'id' => 2300,
                    'accessibilities_name' => AccessibilityInventory::INVENTORY_PROCUREMENT_REQUESTPRICEQUOTATION_REQUESTS->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 2310,
                    'accessibilities_name' => AccessibilityInventory::INVENTORY_PROCUREMENT_REQUESTPRICEQUOTATION_ALLQUOTATIONS->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
                [
                    'id' => 2320,
                    'accessibilities_name' => AccessibilityInventory::INVENTORY_PROCUREMENT_REQUESTPRICEQUOTATION_MYQUOTATIONS->value,
                    'deleted_at' => null,
                    'created_at' => Carbon::now(),
                    'updated_at' => Carbon::now(),
                ],
