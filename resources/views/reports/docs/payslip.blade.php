    ...
    <body style="width: 210mm; height: 297mm; margin: 0; padding: 0; font-family: 'AkagiPro-extrabold'">
        <div style="page-break-before: always; height: 50%; width: 100%; overflow:hidden;">
            ...
            <div style="display:flex; justify-content: space-between;">
                <table>
                    <tr>
                        <td class="payroll_label">Employee Name: </td>
                        <td></td>
                        <td class="payroll_label">Rate: </td>
                        <td class="payroll_label">Total Days of Work: </td>
                    </tr>
                    <tr>
                        <td class="payroll_label">Pay Period: </td>
                        <td></td>
                        <td class="payroll_label">Section / Proj: </td>
                        <td class="payroll_label"></td>
                    </tr>
                </table>
            </div>
            <div style="display: flex;">
                <table style="width: 55%; height:fit-content; table-layout: fixed">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; padding-right:10px;">asd</td>
                        <td style="text-align: right; padding-right:10px;">asd</td>
                    </tr>
                    <tr>
                        <td class="payroll_label" style="text-align: right; padding-right:10px;">Basic reg  hrs. -</td>
