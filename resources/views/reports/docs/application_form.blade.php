...
<body>
    <div class="h-full w-full">
        <label class="block text-lg font-medium text-gray-900 dark:text-white pb-4">
            Application Form
        </label>
        <form>
            <div class="grid md:grid-cols-3 md:gap-6">
                <label class="block text-sm font-medium text-gray-900 dark:text-white pb-4 col-span-2">
                    I. Personal Information
                </label>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->date_of_application }}" id="floating_date_of_application" type="date" name="floating_date_of_application" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-4 md:gap-6">
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-2">
                        <input value="{{ $application->firstname }}" id="floating_firstname" type="text" name="floating_firstname" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-2">
                        <input value="{{ $application->middlename }}" id="floating_middlename" type="text" name="floating_middlename" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-2">
                        <input value="{{ $application->lastname }}" id="floating_lastname" type="text" name="floating_lastname" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                        <label for="floating_lastname" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                            Last Name</label>
                    </div>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->date_of_birth }}" id="floating_date_of_birth" type="date" name="floating_date_of_birth" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->per_address_street }}" id="floating_per_address_street" type="text" name="floating_per_address_street" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->per_address_brgy }}" id="floating_per_address_barangay" type="text" name="floating_per_address_barangay" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->per_address_city }}" id="floating_per_address_city" type="text" name="floating_per_address_city" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->per_address_zip }}" id="floating_per_address_zip" type="text" name="floating_per_address_zip" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->per_address_province }}" id="floating_per_address_province" type="text" name="floating_per_address_province" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->pre_address_brgy }}" id="floating_pre_address_street" type="text" name="floating_pre_address_street" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->pre_address_brgy }}" id="floating_pre_address_brgy" type="text" name="floating_pre_address_brgy" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->pre_address_city }}" id="floating_pre_address_city" type="text" name="floating_pre_address_city" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->pre_address_zip }}" id="floating_pre_address_zip" type="text" name="floating_pre_address_zip" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div>
                    <div class="relative z-0 w-full mb-5 group col-span-3">
                        <input value="{{ $application->pre_address_province }}" id="floating_pre_address_province" type="text" name="floating_pre_address_province" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->contact_info }}" id="floating_contact_info" type="text" name="floating_contact_info" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->email }}" id="floating_email" type="email" name="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_email" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email</label>
                </div>
            </div>
            <div class="grid md:grid-cols-3 md:gap-6">
                <div class="relative z-0 w-full mb-5 group col-span-3">
                    <input value="{{ $application->how_did_u_learn_about_our_company }}" id="floating_how_did_u_learn_about_our_company" type="text" name="floating_how_did_u_learn_about_our_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->desired_position }}" id="floating_desired_position" type="text" name="floating_desired_position" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->currently_employed }}" id="floating_currently_employed" type="text" name="floating_currently_employed" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_currently_employed" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Are you currently employed?</label>
                </div>
            </div>
            <div class="grid md:grid-cols-3 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->place_of_birth }}" id="floating_placeOfBirth" type="text" name="floating_placeOfBirth" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->citizenship }}" id="floating_citizenship" type="text" name="floating_citizenship" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->gender }}" id="floating_gender" type="text" name="floating_gender" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->blood_type }}" id="floating_bloodType" type="text" name="floating_bloodType" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->currently_employed }}" id="floating_religion" type="text" name="floating_religion" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->civil_status }}" id="floating_civil_status" type="text" name="floating_civil_status" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-3 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->date_of_marriage }}" id="floating_dateOfMarriage" type="text" name="floating_dateOfMarriage" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->height }}" id="floating_height" type="text" name="floating_height" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->weight }}" id="floating_weight" type="text" name="floating_weight" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                    <label for="floating_weight" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Gender</label>
                </div>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->sss }}" id="floating_SSS" type="text" name="floating_SSS" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->father_name }}" id="floating_fathersName" type="text" name="floating_fathersName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->mother_name }}" id="floating_mothersName" type="text" name="floating_mothersName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->pagibig }}" id="floating_pagibig" type="text" name="floating_pagibig" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->tin }}" id="floating_TIN" type="text" name="floating_TIN" class="block py-2.5 px-0 w-full text-sm
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->name_of_spouse }}" id="floating_name_of_spouse" type="text" name="floating_name_of_spouse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->date_of_birth_spouse }}" id="floating_date_of_birth_spouse" type="text" name="floating_date_of_birth_spouse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->occupation_spouse }}" id="floating_occupation_spouse" type="text" name="floating_occupation_spouse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->telephone_spouse }}" id="floating_telephone_spouse" type="text" name="floating_telephone_spouse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <!-- NEED TO FOR EACH CHILDREN -->
            @foreach (json_decode($application->children) as $child)
            <div class="grid md:grid-cols-4 md:gap-6">
                <div class="relative z-0 w-full mb-5 group col-span-2">
                    <input value="{{ $child->name }}" id="floating_children_name" type="text" name="floating_children_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $child->birthdate }}" id="floating_children_birthdate" type="date" name="floating_children_birthdate" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->icoe_name }}" id="floating_icoe_name" type="text" name="floating_icoe_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_icoe_name" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->icoe_address }}" id="floating_icoe_address" type="text" name="floating_icoe_address" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->icoe_relationship }}" id="floating_icoe_relationship" type="text" name="floating_icoe_relationship" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $application->telephone_icoe }}" id="floating_telephone_icoe" type="text" name="floating_telephone_icoe" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <?php $education = json_decode($application->education)[0]; ?>
            <div class="grid md:grid-cols-5 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="floating_level" type="text" name="floating_educLevel" class="block py-2.5 px-0 w-full text-sm font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Elementary" disabled="">
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->elementary_name }}" id="floating_elementary_name" type="text" name="floating_schlName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->elementary_education }}" id="floating_educCourse" type="text" name="floating_educCourse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->elementary_period_attendance_to }}" id="floating_fromTo" type="text" name="floating_fromTo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->elementary_year_graduated }}" id="floating_yearGrad" type="text" name="floating_yearGrad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
            ...
            <div class="grid md:grid-cols-5 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="floating_educLevel" type="text" name="floating_educLevel" class="block py-2.5 px-0 w-full text-sm font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Secondary" disabled="">
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->secondary_name }}" id="floating_schlName" type="text" name="floating_schlName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_schlName" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name of School</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->secondary_education }}" id="floating_educCourse" type="text" name="floating_educCourse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_educCourse" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Basic Education/Degree/Course</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->secondary_period_attendance_to }}" id="floating_fromTo" type="text" name="floating_fromTo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_fromTo" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Peroid of Attendance(From-To)</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->secondary_year_graduated }}" id="floating_yearGrad" type="text" name="floating_yearGrad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_yearGrad" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Year Graduated</label>
                </div>
            </div>
            <div class="grid md:grid-cols-5 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="floating_educLevel" type="text" name="floating_educLevel" class="block py-2.5 px-0 w-full text-sm font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Vocational/Trade Course" disabled="">
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->vocationalcourse_name }}" id="floating_schlName" type="text" name="floating_schlName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_schlName" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name of School</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->vocationalcourse_education }}" id="floating_educCourse" type="text" name="floating_educCourse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_educCourse" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Basic Education/Degree/Course</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->vocationalcourse_period_attendance_to }}" id="floating_fromTo" type="text" name="floating_fromTo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_fromTo" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Peroid of Attendance(From-To)</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->vocationalcourse_year_graduated }}" id="floating_yearGrad" type="text" name="floating_yearGrad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_yearGrad" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Year Graduated</label>
                </div>
            </div>
            <div class="grid md:grid-cols-5 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="floating_educLevel" type="text" name="floating_educLevel" class="block py-2.5 px-0 w-full text-sm font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="College" disabled="">
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->college_name }}" id="floating_schlName" type="text" name="floating_schlName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_schlName" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name of School</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->college_education }}" id="floating_educCourse" type="text" name="floating_educCourse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_educCourse" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Basic Education/Degree/Course</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->college_period_attendance_to }}" id="floating_fromTo" type="text" name="floating_fromTo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_fromTo" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Peroid of Attendance(From-To)</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->college_year_graduated }}" id="floating_yearGrad" type="text" name="floating_yearGrad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_yearGrad" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Year Graduated</label>
                </div>
            </div>
            <div class="grid md:grid-cols-5 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="floating_educLevel" type="text" name="floating_educLevel" class="block py-2.5 px-0 w-full text-sm font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Graduate Studies" disabled="">
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->graduatestudies_name }}" id="floating_schlName" type="text" name="floating_schlName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_schlName" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name of School</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->graduatestudies_education }}" id="floating_educCourse" type="text" name="floating_educCourse" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_educCourse" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Basic Education/Degree/Course</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->graduatestudies_period_attendance_to }}" id="floating_fromTo" type="text" name="floating_fromTo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_fromTo" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Peroid of Attendance(From-To)</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $education->graduatestudies_year_graduated }}" id="floating_yearGrad" type="text" name="floating_yearGrad" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    <label for="floating_yearGrad" class="peer-focus:font-medium absolute text-xs text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Year Graduated</label>
                </div>
            </div>
            <label class="block text-sm font-medium text-gray-900 dark:text-white pb-4 italic">IV. Work Experience</label>
            @foreach(json_decode($application->workexperience) as $workexperience)
            <div class="grid md:grid-cols-3 md:gap-4">
                <div class="relative z-0 w-full mb-5 group">
                    <div class="flex-1">
                        From
                        <input value="{{ $workexperience->inclusive_dates_from }}" id="inclusive_dates_from" type="text" class="block w-36 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        To
                        <input value="{{ $workexperience->inclusive_dates_to }}" id="inclusive_dates_to" type="text" class="block w-36 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $workexperience->position_title }}" id="floating_positionTitles" type="text" name="floating_positionTitles" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $workexperience->dpt_agency_office_company }}" id="floating_dept" type="text" name="floating_dept" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $workexperience->monthly_salary }}" id="floating_monthlySal" type="text" name="floating_monthlySal" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input value="{{ $workexperience->status_of_appointment }}" id="floating_statAppt" type="text" name="floating_statAppt" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
