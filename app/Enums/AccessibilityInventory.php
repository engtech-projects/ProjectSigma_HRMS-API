...
enum AccessibilityInventory: string
{
    ...
    case INVENTORY_WAREHOUSE_OVERVIEW = "inventory:warehouse_overview";
    case INVENTORY_WAREHOUSE_VIEWONLY = "inventory:warehouse_view only";
    case INVENTORY_WAREHOUSE_PSSMANAGER = "inventory:warehouse_pss manager";
