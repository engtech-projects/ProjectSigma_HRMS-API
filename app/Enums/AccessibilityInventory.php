...
enum AccessibilityInventory: string
{
    ...
    case INVENTORY_WAREHOUSE_MATERIALSRECEIVING_FORM = "inventory:warehouse_overview_materials receiving_form and my requests";
    case INVENTORY_WAREHOUSE_MATERIALSRECEIVING_ALLREQUESTS = "inventory:warehouse_overview_materials receiving_all requests";
