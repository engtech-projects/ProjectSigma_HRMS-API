...
enum AccessibilityAccounting: string
{
    ...
    case ACCOUNTING_VOUCHER_DISBURSEMENT_ALL = "accounting:request_disbursement-list_all request";
    case ACCOUNTING_VOUCHER_DISBURSEMENT_MY_REQUEST = "accounting:request_disbursement-list_my request";
    case ACCOUNTING_VOUCHER_DISBURSEMENT_MY_APPROVAL = "accounting:request_disbursement-list_my approval";
    case ACCOUNTING_VOUCHER_DISBURSEMENT_FOR_DISBURSEMENT_VOUCHER = "accounting:request_disbursement-list_for disbursement voucher";
    case ACCOUNTING_VOUCHER_CASH = "accounting:voucher_cash";
    case ACCOUNTING_VOUCHER_CASH_ALL = "accounting:request_cash-list_all request";
    case ACCOUNTING_VOUCHER_CASH_MY_REQUEST = "accounting:request_cash-list_my request";
    case ACCOUNTING_VOUCHER_CASH_MY_APPROVAL = "accounting:request_cash-list_my approval";
    case ACCOUNTING_VOUCHER_CASH_FOR_CASH_VOUCHER = "accounting:request_cash-list_for cash voucher";
