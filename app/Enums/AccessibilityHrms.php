...
enum AccessibilityHrms: string
{
    ...
    case HRMS_LOANSANDADVANCES_LOANS = "hrms:loans and advances_loans";
    case HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS = "hrms:loans and advances_other deductions";
    // case HRMS_ = "";
    case HRMS_PAYROLL_SALARY_GENERATEPAYROLL = "hrms:payroll_generate payroll";
    case HRMS_PAYROLL_13THMONTH = "hrms:payroll_13th month";
    case HRMS_PAYROLL_ALLOWANCE = "hrms:payroll_allowance";
    case HRMS_PAYROLL_SALARY_PAYROLLRECORD = "hrms:payroll_payroll record";
    ...
    case HRMS_LOANSANDADVANCES_CASHADVANCE_FORM = "hrms:loans and advances_cash advance_forms";
    case HRMS_LOANSANDADVANCES_CASHADVANCE_ALLREQUESTS = "hrms:loans and advances_cash advance_list";
    case HRMS_LOANSANDADVANCES_CASHADVANCE_MYAPPROVALS = "hrms:loans and advances_cash advance_approvals";
