...
class ReportService
{
    ...
    */
    ...
    public static function employeeGenerateDtr($validate)
    {
    ...
    public static function employeeAbsenties($validate)
    {
        $dateFrom = Carbon::parse($validate["date_from"]);
        $dateTo = Carbon::parse($validate["date_to"]);
        $generateDtr = ReportService::employeeGenerateDtr($validate);
        ...
        $newData = $generateDtr->map(function ($employee) use ($dateFrom, $dateTo, $events) {
            $employeeAttendance = ReportService::employeeAttendance($employee, $dateFrom, $dateTo, $events);
            return [
