...
class AdministrativeEmployeeMasterList extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "date_of_birth" => $this['date_of_birth'] ? Carbon::parse($this['date_of_birth'])->format('F j, Y') : null,
            ...
            "height" => $this['height'],
            "weight" => $this['weight'],
            "date_of_marriage" => $this['date_of_marriage'] ? Carbon::parse($this['date_of_marriage'])->format('F j, Y') : null,
            "father" => $this->father?->name,
            "mother" => $this->mother?->name,
            "spouse" => $this->spouse?->name,
            "spouse_date_of_birth" => $this->spouse?->date_of_birth ? Carbon::parse($this->spouse?->date_of_birth)->format('F j, Y') : null,
