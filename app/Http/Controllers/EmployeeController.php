...
class EmployeeController extends Controller
{
    ...
    public function show($id)
    {
        ...
        "employee_education",
        "employee_education_elementary:employee_id,elementary_name,elementary_education,elementary_period_attendance_to,elementary_period_attendance_from,elementary_year_graduated",
        "employee_education_secondary:employee_id,secondary_name,secondary_education,secondary_period_attendance_to,secondary_period_attendance_from,secondary_year_graduated",
        "employee_education_vocationalcourse:employee_id,vocationalcourse_name,vocationalcourse_education,vocationalcourse_period_attendance_to,vocationalcourse_period_attendance_from,vocationalcourse_year_graduated",
        "employee_education_college:employee_id,college_name,college_education,college_period_attendance_to,college_period_attendance_from,college_year_graduated",
