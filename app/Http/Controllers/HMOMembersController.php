...
use App\Http\Requests\UpdateHMOMembersRequest;

class HMOMembersController extends Controller
{
    /**
     ...
     */
    public function edit(HMOMembers $hMOMembers)
    {
        //
    }
     ...
     */
    public function update(UpdateHMOMembersRequest $request, $id)
    {
